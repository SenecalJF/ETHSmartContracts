...
// Goal: 2 individuals agree play a coin flip game. They each send an identical amount of ETH to the contract.
// Then contract then flips a coin (pseudo-random boolean) and sends all the ETH to the winner (2 times the intial bet).
